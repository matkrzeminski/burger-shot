...
#
#
# def test_city_view_set_create_state_and_country_does_not_match(
#     city, superuser, superuser_token
# ):
#     client = APIClient()
#     client.credentials(HTTP_AUTHORIZATION="Bearer " + superuser_token)
#     url = reverse("city-list")
...
#         "name": "New City",
#         "state": city.state.name,
#         "country": new_city.state.country.name,
#     }
#     response = client.post(url, data, format="json")
#     assert response.status_code == 404
...
#
#
# def test_city_view_set_create_country_and_state_does_not_match(
#     city, superuser, superuser_token
# ):
#     client = APIClient()
#     client.credentials(HTTP_AUTHORIZATION="Bearer " + superuser_token)
...
#
#
# def test_cty_view_set_update_country_and_state_does_not_match(
#     city, superuser, superuser_token
# ):
#     client = APIClient()
#     client.credentials(HTTP_AUTHORIZATION="Bearer " + superuser_token)
